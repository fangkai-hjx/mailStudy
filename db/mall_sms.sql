...
MySQL - 5.7.32-log : Database - mall_sms
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`mall_sms` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_german2_ci */;
...
CREATE TABLE `sms_coupon` (
  ...
  `coupon_img` varchar(2000) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '优惠券图片',
  `coupon_name` varchar(100) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '优惠卷名字',
  ...
  `note` varchar(200) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '备注',
  ...
  `code` varchar(64) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '优惠码',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='优惠券信息';
...
CREATE TABLE `sms_coupon_history` (
  ...
  `member_nick_name` varchar(64) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '会员名字',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='优惠券领取历史记录';
...
CREATE TABLE `sms_coupon_spu_category_relation` (
  ...
  `category_name` varchar(64) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '产品分类名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='优惠券分类关联';
...
CREATE TABLE `sms_coupon_spu_relation` (
  ...
  `spu_name` varchar(255) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT 'spu_name',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='优惠券与产品关联';
...
CREATE TABLE `sms_home_adv` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(100) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '名字',
  `pic` varchar(500) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '图片地址',
  `start_time` datetime DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '结束时间',
  `status` tinyint(1) DEFAULT NULL COMMENT '状态',
  `click_count` int(11) DEFAULT NULL COMMENT '点击数',
  `url` varchar(500) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '广告详情连接地址',
  `note` varchar(500) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '备注',
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  `publisher_id` bigint(20) DEFAULT NULL COMMENT '发布者',
  `auth_id` bigint(20) DEFAULT NULL COMMENT '审核者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='首页轮播广告';
...
CREATE TABLE `sms_home_subject` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(200) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '专题名字',
  `title` varchar(255) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '专题标题',
  `sub_title` varchar(255) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '专题副标题',
  `status` tinyint(1) DEFAULT NULL COMMENT '显示状态',
  `url` varchar(500) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '详情连接',
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  `img` varchar(500) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '专题图片地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】';
...
CREATE TABLE `sms_home_subject_spu` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='专题商品';
...
CREATE TABLE `sms_member_price` (
  ...
  `member_level_name` varchar(100) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '会员等级名',
  `member_price` decimal(18,4) DEFAULT NULL COMMENT '会员对应价格',
  `add_other` tinyint(1) DEFAULT NULL COMMENT '可否叠加其他优惠[0-不可叠加优惠，1-可叠加]',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='商品会员价格';
...
CREATE TABLE `sms_seckill_promotion` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `title` varchar(255) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '活动标题',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='秒杀活动';
...
CREATE TABLE `sms_seckill_session` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(200) COLLATE utf8mb4_german2_ci DEFAULT NULL COMMENT '场次名称',
  `start_time` datetime DEFAULT NULL COMMENT '每日开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '每日结束时间',
  `status` tinyint(1) DEFAULT NULL COMMENT '启用状态',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='秒杀活动场次';
...
CREATE TABLE `sms_seckill_sku_notice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='秒杀商品通知订阅';
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='秒杀活动商品关联';
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='商品满减信息';
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='商品阶梯价格';
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_german2_ci COMMENT='商品spu积分设置';

/*Data for the table `sms_spu_bounds` */

insert  into `sms_spu_bounds`(`id`,`spu_id`,`grow_bounds`,`buy_bounds`,`work`) values (2,8,'0.0000','0.0000',NULL),(3,12,'10.0000','50.0000',NULL);
